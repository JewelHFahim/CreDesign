  ...
  return (
    <div className="mt-5 lg:mt-[50px] mb-8 flex flex-col justify-center items-center overflow-hidden">
      ...
      >
        ...
        <div className="mt-4 w-full flex flex-col-reverse lg:flex-row-reverse justify-between px-4 lg:px-[40px] gap-y-4 lg-gap-y-0">
          <div className=" lg:w-1/2 flex flex-col items-start">
            <p className="lg:w-[60%] font-medium">
              Fast track your online casino’s launch with our complete iGaming
              White Label Package. Choose from the top iGaming products and
          ...
          <div className=" lg:w-1/2">
            <img src={img2} alt="" className="lg:h-[350px]" />
          </div>
        </div>
      </div>
      ...
      >
        ...
        <div className="mt-4 w-full flex flex-col-reverse lg:flex-row justify-between px-4 lg:px-[40px] gap-y-4 lg-gap-y-0">
          <div className=" lg:w-1/2 flex flex-col items-start">
            <p className="lg:w-[60%] font-medium">
              Fast track your online casino’s launch with our complete iGaming
              White Label Package. Choose from the top iGaming products and
          ...
          <div className=" lg:w-1/2">
            <img src={img3} alt="" className="lg:h-[350px]" />
          </div>
        </div>
      </div>
      ...
      >
        ...
        <div className="mt-4 w-full flex flex-col-reverse lg:flex-row-reverse justify-between px-4 lg:px-[40px] gap-y-4 lg-gap-y-0">
          ...
          <div className=" lg:w-1/2">
            <img src={img4} alt="" className="lg:h-[350px]" />
          </div>
        </div>
      </div>
      ...
      >
        ...
        <div className="t-4 w-full flex flex-col-reverse lg:flex-row justify-between px-4 lg:px-[40px] gap-y-4 lg-gap-y-0">
          <div className=" lg:w-1/2 flex flex-col items-start">
            <p className="lg:w-[60%] font-medium">
              Fast track your online casino’s launch with our complete iGaming
              White Label Package. Choose from the top iGaming products and
          ...
          <div className=" lg:w-1/2">
            <img src={img5} alt="" className="lg:h-[350px]" />
          </div>
        </div>
      </div>
