...
const Footer = () => {
    ...
    return (
        <div className="bg-black">
            <div className="px-10 py-10 lg:px-[120px] lg:py-[100px] flex flex-col lg:flex-row justify-center items-center lg:justify-between lg:gap-x-[100px]">
                ...
                <div className="mt-5 lg:mt-0">
                    <h1 className="lg:text-[35px] text-white font-medium lg:font-semibold lg:w-[360px] lg:leading-[60px]">Lets Make Consultation With Us!</h1>

                    <div className="flex items-center mt-2 lg:mt-5">
                        <input placeholder="Enter your email" type="text" className="py-3 lg:w-[300px] h-[48px] border-r-0 rounded-s-md bg-transparent border border-slate-600 text-white focus:outline-none px-4" />
                        <div className="w-[45px] h-[48px] rounded-e-md bg-orange-500 text-white flex justify-center items-center"> <FaTelegramPlane /> </div>
                    </div>
                </div>
            </div>
